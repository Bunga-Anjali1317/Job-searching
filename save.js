...
if (savedjobs.length === 0) {
    document.getElementById("savedcards").innerHTML = "<p>No saved jobs.</p>";
}
const jobsContainer = document.getElementById('savedcards');
savedjobs.forEach(jobId => {
    const jobsContainer1 = document.getElementById('savedcards');
